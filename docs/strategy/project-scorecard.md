...
1. Resolve data feasibility.
2. Build financial-period and formula tests.
3. Deliver one LangGraph thin slice with a real trace.
4. Add deterministic verification.
5. Attempt the Evolution hypothesis only after genuine repeated failures exist.
6. Add breadth and UI after the core is credible.

## Refresh Rules

- Refresh this file at every gate and whenever a blocker materially changes.
- A status may move backward when evidence regresses.
- Do not mark Career Usefulness Green from documentation alone.
- Do not mark Product Usefulness Green from the project owner's opinion alone.
- Do not average the dimensions into a vanity score.
