...
1. select the intended company and period;
2. submit a research question;
3. explain the executive conclusion in their own words;
4. locate one supporting source;
5. locate one limitation or counter-evidence item; and
6. identify one next-period monitoring item.

## Evidence rules

- Only an actual participant session is labeled `REAL_HUMAN`.
- Simulated usability records remain `SIMULATED` V1.4 evidence and never count toward the pilot.
