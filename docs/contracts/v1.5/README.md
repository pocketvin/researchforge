...
| Contract | Governs |
|---|---|
| [`real-data-ingestion.md`](real-data-ingestion.md) | Official-disclosure discovery, acquisition, parsing, provenance, isolation and abstention |
...
The contract package is intentionally narrow: one real filing slice must work before adding
broader company coverage, new modes or infrastructure.
